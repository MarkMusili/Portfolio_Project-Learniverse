...
declare type ImplicitOnError = (onError: Pick<TokenResponse, 'error' | 'error_description' | 'error_uri'>) => void;
...
declare type AuthCodeOnError = (onError: Pick<TokenResponse, 'error' | 'error_description' | 'error_uri'>) => void;
...
declare type CredentialOnSuccess = (credentialResponse: Omit<CredentialResponse, 'error' | 'error_description' | 'error_uri'>) => void;
declare type CredentialOnError = () => void;
interface CredentialFlowOptions extends Omit<IdConfiguration, 'client_id' | 'callback'> {
...
declare type UseGoogleLoginOptionsCredentialFlow = {
    flow?: 'credential';
} & CredentialFlowOptions;
declare type UseGoogleLoginOptions = UseGoogleLoginOptionsImplicitFlow | UseGoogleLoginOptionsAuthCodeFlow | UseGoogleLoginOptionsCredentialFlow;
...
declare function useGoogleLogin(options: UseGoogleLoginOptionsCredentialFlow): () => void;
